/* Integer */
// Cannot compare long to INT_MAX+1, since INT_MAX+1 will auto type conversion, the correct way will be 
long a = 1;
...
// When known index, use vector is faster than use unordered_map
...
// Get the rest of string including position i
...
// Use dummy node as head and return next of this dummy node
ListNode dummy(-1);
dummy->next = l1;
return dummy->next;
...
/* Performance */
// Use monolithic design is faster than separate each part into different function.
